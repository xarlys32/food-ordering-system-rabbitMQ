package com.food.ordering.system.restaurant.infrastructure.persistence.repository;
 ...
 */
public interface RestaurantJpaRepository extends JpaRepository<OrderJpaEntity, UUID> {
}
